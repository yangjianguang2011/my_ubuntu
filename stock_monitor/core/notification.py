...
def send_stock_alert(
    stock_name, stock_code, current_price, target_price, alert_type, change_pct=None
):
    """
    发送股票价格警报
...
"""
            ...
            direction = (
                ...
                else "下跌" if actual_change_pct < 0 else "持平"
            )
            ...
            change_pct_value = (
                actual_change_pct if actual_change_pct is not None else 0.0
            )
