...
SCRIPT_DIR="/root/stock_monitor"
PYTHON_SCRIPT="eastmoney_analyst.py"
DATA_DIR="/data/stock_monitor/analyst_data"
XUEQIU_DATA_DIR="/data/stock_monitor/xueqiu_data"
LOG_FILE="/var/log/eastmoney_analyst.log"
...
run_python_crawler() {
    ...
    if python3 generate_html_reports.py 2>&1 | tee -a "$LOG_FILE"; then
