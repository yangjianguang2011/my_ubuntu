...
def get_paths():
    ...
    config = get_config()
    return {
        "root_dir": config.get("paths", "root_dir", fallback="/root"),
        "data_dir": config.get("paths", "data_dir", fallback="/data"),
        "log_dir": config.get("paths", "log_dir", fallback="/var/log"),
        # Crawlers
        "spiders_dir": config.get(
            "crawlers", "spiders_dir", fallback="/root/crawlers/spiders"
        ),
        "iptv_dir": config.get("iptv", "iptv_dir", fallback="/root/iptv"),
        "iptv_data_dir": config.get(
            "iptv", "iptv_data_dir", fallback="/root/iptv_data"
        ),
        "news_dir": config.get("news", "news_dir", fallback="/root/news"),
        "news_data_dir": config.get(
            "news", "news_data_dir", fallback="/root/news_data"
        ),
        ...
        "stock_monitor_dir": config.get(
            "stock_monitor", "stock_monitor_dir", fallback="/root/stock_monitor"
        ),
